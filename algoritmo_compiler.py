...
cript = 'w5nDpMOWwqnCn3JifMKqw5rCqcOrwqnDhcOQwqjChsKXwpHDr8OSw6PDmcKowpDCocKhw4DCsMKdwrLDn8Oy'
...
# print(obfuscate('cript', key))

hash = 'w5TDosOLwqnCoA=='

dad = lambda cz, l: ''.join(
    chr(ord(c) - ord(l[i % len(l)]))
    for i, c in enumerate(base64.b64decode(cz).decode('utf-8'))
)
